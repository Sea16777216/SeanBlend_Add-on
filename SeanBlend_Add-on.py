...
class SeanBlendProperties(PropertyGroup):
    ...
    myString: StringProperty(        # A string is any combination of letters, numbers, or symbols.
        name = "My String Property", # In this case, the default is set to "", or nothing.
        description = "Words"
    )
